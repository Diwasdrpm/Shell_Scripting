...
{
    FILE* inp = fopen("/utkarsh_des/files/input.txt", "rb");
    out = fopen("/utkarsh_des/files/bits.txt", "wb+");
    char ch;
    int i = n * 8;
...
{
    out = fopen("/utkarsh_des/files/cipher.txt", "ab+");
    for (int i = 0; i < 64; i++) {
...
{
    out = fopen("/utkarsh_des/files/decrypted.txt", "ab+");
    for (int i = 0; i < 64; i++) {
        initialPermutation(i, plain[i]);
    }
...
void bittochar()
{
    out = fopen("/utkarsh_des/files/result.txt", "ab+");
...
{
    FILE* in = fopen("/utkarsh_des/files/cipher.txt", "rb");
    long int plain[n * 64];
    int i = -1;
    char ch;
...
{
    FILE* in = fopen("/utkarsh_des/files/bits.txt", "rb");
...
void create16Keys()
{
    FILE* pt = fopen("/utkarsh_des/files/key.txt", "rb");
    unsigned int key[64];
    int i = 0, ch;
...
void launchdes(){
        // destroy contents of these files (from previous runs, if any)
    out = fopen("/utkarsh_des/files/result.txt", "wb+");
    fclose(out);
 
    out = fopen("/utkarsh_des/files/decrypted.txt", "wb+");
    fclose(out);
 
    out = fopen("/utkarsh_des/files/cipher.txt", "wb+");
    fclose(out);
